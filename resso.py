...
CARPETA_ARRANQUE = [
    ...
    (19, 'Mapa de procesos y Matriz IPER', 'Mapa de procesos (SIGO-F-011) y Matriz IPER (SIGO-F-006), trazable, con controles de RC vía Bow Tie. RESSO B.3.', 'Adm. Ctto.'),
...
EQUIVALENCIAS = {
    ...
    'iper':            {'carpeta': 19, 'reso': 'B.3', 'titulo': 'Mapa de procesos y Matriz IPER (metodología de identificación de peligros)'},
