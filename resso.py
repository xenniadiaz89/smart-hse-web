...
CARPETA_ARRANQUE = [
    ...
    (19, 'Mapa de procesos y Matriz IPER', 'Mapa de procesos (SIGO-F-011) y Matriz IPER (SIGO-F-006), con registro de identificación de peligros y evaluación de riesgos acorde a las actividades del contrato y en concordancia con la Carta Gantt. RESSO B.5.3.', 'Adm. Ctto.'),
...
EQUIVALENCIAS = {
    ...
    'iper':            {'carpeta': 19, 'reso': 'B.5.3', 'titulo': 'Registro de identificación de peligros y evaluación de riesgos (IPER) acorde a las actividades del contrato y Carta Gantt — Mapa de procesos (SIGO-F-011) + Matriz IPER (SIGO-F-006)'},
